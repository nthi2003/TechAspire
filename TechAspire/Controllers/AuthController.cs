...
namespace TechAspire.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Register(AppUserModel appUser)
        {
            try
            {
				...
				var message = "Chúc mừng bạn đã đăng ký thành công!";
		...
		public async Task<IActionResult> Login(LoginModel loginModel)
		{
			try
			{
				...
				var message = "Chào mừng bạn quay lại!";
				await _emailSender.SendEmailAsync(receiver, subject, message);
			...
			var claims = new List<Claim>
	{
		...
		new Claim("id", appUser.Id),  // Đảm bảo Id của user không rỗng
        new Claim(ClaimTypes.Role, "user")
			...
			var token = new JwtSecurityToken(
				...
				claims,
				expires: DateTime.Now.AddMinutes(30),  // Token hết hạn trong 30 phút
